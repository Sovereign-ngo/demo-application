...
function parseBasicAuthorization(headerValue) {
  ...
  if (!normalized.startsWith('Basic ')) return null;
...
export async function onRequest(context) {
  ...
  if (!valid) return basicAuthChallenge();
