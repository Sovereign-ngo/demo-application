    ...
    "subsectors": [
      {
        ...
        "note": "Driver licensing and transportation program administration.",
        "services": [
          {
            "id": "state-driver-licensing-agency",
            "title": "State Driver Licensing Agency (926120 - Regulation and Administration of Transportation Programs)",
            "type": "identity-vc-issuer",
            "endpointKeys": ["verifier_drivers_license"]
          }
        ]
      },
      {
        "id": "naics-928",
        "title": "928 - National Security and International Affairs",
        "note": "Passport and international affairs administration.",
        "services": [
          {
            "id": "united-states-passport-office",
            "title": "United States Passport Office (928120 - International Affairs)",
            "type": "identity-vc-issuer",
            "endpointKeys": ["verifier_passport"]
          }
        ]
      }
    ]
